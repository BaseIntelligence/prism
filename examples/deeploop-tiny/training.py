# PRISM deeploop-tiny ~1M-parameter DeepLoop-class training script.
#
# Training half of the v2 two-script bundle. Outer contract matches Imp
# transformer-tiny-1m / mamba-tiny: forced-init friendly, rank-0 save marker,
# single-node multi-GPU static surface. Challenge owns score (prequential bpb +
# held-out); this return value is ignored.
import torch
...
# Slightly conservative LR for shared-weight loop residual stability.
EFFECTIVE_LEARNING_RATE = 0.004
GRAD_CLIP_NORM = 1.0
LOCAL_BATCH = 4
