# PRISM kda-tiny Kimi Delta Attention training script (v2 two-script).
#
# Outer contract matches Imp transformer-tiny-1m: forced-init friendly, rank-0
# save marker, single-node multi-GPU static surface. Challenge owns scores.
import torch
...
# Conservative LR for sequential KDA multi-gate numerical stability.
